    ...
    <footer className="border-t bg-muted/30">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="https://github.com/avisangle" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">GitHub</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="https://x.com/avi_sangle" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">Twitter</a></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <p>Created by <a href="https://avinashsangle.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground transition-colors">Avinash Sangle</a></p>
          <p>MIT License</p>
        </div>
      </div>
    </footer>
